...
class TypiClust:
    ...
    def init_features_and_clusters(self, is_scan):
        ...
        if is_scan:
            ...
            self.features = ds_utils.load_features(self.ds_name, representation_model=self.representation_model,
                                                       train=True, normalize=True, project=self.cfg.ACTIVE_LEARNING.USE_COSINE_DIST)
